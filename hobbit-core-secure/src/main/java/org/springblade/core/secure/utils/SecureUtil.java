package com.hobbit.core.secure.utils;
...
import com.my.core.launch.constant.TokenConstant;
import com.hobbit.core.secure.BladeUser;
import com.hobbit.core.secure.TokenInfo;
import com.hobbit.core.secure.constant.SecureConstant;
import com.hobbit.core.secure.exception.SecureException;
import com.hobbit.core.secure.provider.IClientDetails;
import com.hobbit.core.secure.provider.IClientDetailsService;
import com.hobbit.core.tool.constant.RoleConstant;
...
public class SecureUtil {
  ...
  private static boolean validateClient(IClientDetails clientDetails, String clientId,
    ...
    if (clientDetails != null) {
      return StringUtil.equals(clientId, clientDetails.getClientId()) && StringUtil
          .equals(clientSecret, clientDetails.getClientSecret());
    }
    return false;
  }
