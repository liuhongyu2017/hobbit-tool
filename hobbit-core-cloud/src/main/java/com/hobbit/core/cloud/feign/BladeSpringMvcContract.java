package com.hobbit.core.cloud.feign;

import feign.MethodMetadata;
import java.lang.annotation.Annotation;
import java.lang.reflect.Method;
import java.util.List;
import com.hobbit.core.cloud.annotation.ApiVersion;
import com.hobbit.core.cloud.annotation.UrlVersion;
import com.hobbit.core.cloud.version.BladeMediaType;
 ...
 *
 * @see com.hobbit.core.cloud.annotation.UrlVersion
 * @see com.hobbit.core.cloud.annotation.ApiVersion
 * @author L.cm
 */
public class BladeSpringMvcContract extends SpringMvcContract {

  public BladeSpringMvcContract(List<AnnotatedParameterProcessor> annotatedParameterProcessors,
