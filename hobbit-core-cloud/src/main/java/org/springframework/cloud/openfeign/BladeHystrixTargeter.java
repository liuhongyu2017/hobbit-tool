...
import com.hobbit.core.cloud.feign.BladeFallbackFactory;
...
public class BladeHystrixTargeter implements Targeter {
  ...
  private <T> T targetWithFallback(String feignClientName, FeignContext context,
    ...
    T fallbackInstance = getFromContext("fallback", feignClientName, context, fallback,
        target.type());
    return builder.target(target, fallbackInstance);
  }

  private <T> T getFromContext(String fallbackMechanism, String feignClientName,
      FeignContext context, Class<?> beanType,
      Class<T> targetType) {
