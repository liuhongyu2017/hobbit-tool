...
import com.hobbit.core.cloud.feign.BladeFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class BladeFeignClientsRegistrar implements ImportBeanDefinitionRegistrar,
  ...
  private void registerFeignClients(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
    List<String> feignClients = SpringFactoriesLoader
    ...
    for (String className : feignClients) {
      try {
        ...
        AnnotationAttributes attributes = AnnotatedElementUtils
            .getMergedAnnotationAttributes(clazz, FeignClient.class);
        if (attributes == null) {
          continue;
        }
        ...
        registerClientConfiguration(registry, getClientName(attributes),
