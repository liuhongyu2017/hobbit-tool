package com.hobbit.core.launch;
...
import com.hobbit.core.launch.constant.AppConstant;
import com.hobbit.core.launch.constant.NacosConstant;
import com.hobbit.core.launch.constant.SentinelConstant;
import com.hobbit.core.launch.service.LauncherService;
...
public class BladeApplication {
  ...
  public static SpringApplicationBuilder createSpringApplicationBuilder(String appName,
    ...
    System.out
        .println(String.format("----启动中，读取到的环境变量:[%s]，jar地址:[%s]----", activePros, startJarPath));
    ...
    props
        .setProperty("spring.cloud.nacos.config.file-extension", NacosConstant.NACOS_CONFIG_FORMAT);
