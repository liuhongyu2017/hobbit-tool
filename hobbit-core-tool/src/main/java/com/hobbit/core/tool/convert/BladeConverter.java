package com.hobbit.core.tool.convert;

import com.hobbit.core.tool.utils.ConvertUtil;
import com.hobbit.core.tool.utils.ReflectUtil;
import java.lang.reflect.Field;
import java.util.concurrent.ConcurrentHashMap;
import java.util.concurrent.ConcurrentMap;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.hobbit.core.tool.support.Try;
...
public class BladeConverter implements Converter {
  ...
  public Object convert(Object value, Class target, final Object fieldName) {
    ...
    try {
      TypeDescriptor targetDescriptor = BladeConverter
          .getTypeDescriptor(targetClazz, (String) fieldName);
