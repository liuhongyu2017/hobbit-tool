package com.hobbit.core.boot.ctrl;

import java.util.List;
import javax.servlet.http.HttpServletRequest;
import com.hobbit.core.boot.file.BladeFile;
import com.hobbit.core.boot.file.BladeFileUtil;
...
public class BladeController {
   ...
   * @return BladeFile
   */
  public List<BladeFile> getFiles(List<MultipartFile> files, String dir, String path,
      String virtualPath) {
